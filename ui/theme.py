...
[data-testid="stMetricValue"] { font-size: 1.25rem !important; color: #00ffcc; font-family: 'Courier New', monospace; }
...
.qt-section { font-size: 0.78rem; font-weight: 600; letter-spacing: 0.12em; text-transform: uppercase; color: #8892a4; margin: 18px 0 8px 0; }
...
# PLOTLY_LAYOUT — only safe keys that never conflict with per-chart yaxis/xaxis settings
PLOTLY_LAYOUT = dict(
