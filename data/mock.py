"""
data/mock.py — Deterministic demo data using Geometric Brownian Motion.
"""
...
def make_demo_ohlcv() -> pd.DataFrame:
    ...
    # Use simple integer range then convert — avoids business day frequency issues
    dates  = pd.date_range(end=pd.Timestamp.now(), periods=DEMO_PERIODS, freq="D")
